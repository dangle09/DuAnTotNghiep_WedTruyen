...
namespace TeenNovel_Wed.Controllers
{
    public class QuanLyController : Controller
    {
        ...
        public async Task<IActionResult> ThemTruyen()
        {
            ...
            ViewBag.DsTheLoai = await _context.TheLoais
                .OrderBy(x => x.Tentheloai)
                .ToListAsync();

            // Chưa chọn thể loại nào
            ViewBag.SelectedTheLoai = new List<int>();

            ViewBag.DsTacGia = new SelectList(
                _context.TacGias,
                "MaTacGia",
                "TenTacGia");
            ...
            IFormFile? anhbia)
        {
            ...
            if (matheloai == null || !matheloai.Any())
            {
        ...
        .FirstOrDefaultAsync(x => x.Matruyen == id);
            ...
            ViewBag.SelectedTheLoai = truyen.MaTheLoais
                .Select(x => x.Matheloai)
                .ToList();
            ...
            string trangthai, IFormFile? anhbia)
        {
            ...
            if (matheloai == null || !matheloai.Any())
            {
                ...
                ViewBag.DsTacGia = new SelectList(
                    _context.TacGias.OrderBy(x => x.TenTacGia),
                    "MaTacGia",
                    "TenTacGia",
                    truyen.MaTacGia);
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            ViewBag.DoanhThuThangNay = await _context.NapXus
                .Where(n => n.Ngaynap.HasValue
                         && n.Ngaynap.Value.Month == thangNay
                         && n.Ngaynap.Value.Year == namNay
            ...
            ViewBag.DoanhThuThangTruoc = await _context.NapXus
                .Where(n => n.Ngaynap.HasValue && n.Ngaynap.Value.Month == thangTruoc && n.Ngaynap.Value.Year == namThangTruoc
                            && n.Trangthai == "thanhcong")
                .SumAsync(n => (decimal?)n.Sotien) ?? 0;
            ...
            var napXuTrongKy = await _context.NapXus
                .Where(n => n.Ngaynap.HasValue && n.Trangthai == "thanhcong" &&
                            (n.Ngaynap.Value.Year > moc6Thang.Year ||
                             (n.Ngaynap.Value.Year == moc6Thang.Year && n.Ngaynap.Value.Month >= moc6Thang.Month)))
                .ToListAsync();
            ...
            for (int i = 5; i >= 0; i--)
            {
                ...
                var tongTien = napXuTrongKy
                    .Where(n => n.Ngaynap.HasValue && n.Ngaynap.Value.Month == moc.Month && n.Ngaynap.Value.Year == moc.Year)
                    .Sum(n => n.Sotien);
        ...
        public async Task<IActionResult> QuanLyTaiChinh(int? thang, int? nam, string? trangthai, int page = 1)
        {
            ...
            var query = _context.NapXus
                ...
                .Where(n => n.Ngaynap.HasValue && n.Ngaynap.Value.Month == filterThang && n.Ngaynap.Value.Year == filterNam)
                .AsQueryable();
            ...
            var tongLuotNap = await _context.NapXus
                .CountAsync(n => n.Ngaynap.HasValue && n.Ngaynap.Value.Month == filterThang && n.Ngaynap.Value.Year == filterNam);
            ...
            var napXuCaNam = await _context.NapXus
                .Where(n => n.Ngaynap.HasValue && n.Ngaynap.Value.Year == filterNam && n.Trangthai == "thanhcong")
                .ToListAsync();

            var doanhThuNam = new List<(int Thang, decimal TongTien)>();
            for (int t = 1; t <= 12; t++)
            {
                var tongTien = napXuCaNam.Where(n => n.Ngaynap.HasValue && n.Ngaynap.Value.Month == t).Sum(n => n.Sotien);
